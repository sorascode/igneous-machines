...
public class DepositerBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory, SidedInventory {

    private final DefaultedList<ItemStack> inventory = DefaultedList.ofSize(9, ItemStack.EMPTY);

    public DepositerBlockEntity(BlockPos pos, BlockState state) {
        super(IgneousMachinesMod.DEPOSITER_BLOCK_ENTITY, pos, state);
    }
    ...
    public ScreenHandler createMenu(int syncId, PlayerInventory playerInventory, PlayerEntity player) {
        ...
        return new DepositerScreenHandler(syncId, playerInventory, this);
    }
