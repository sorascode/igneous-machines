...
public class DepositerBlock extends BlockWithEntity {
    ...
    public DepositerBlock(Settings settings) {
        super(settings);
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new DepositerBlockEntity(pos, state);
    }
    ...
    public void onPlaced(World world, BlockPos pos, BlockState state, LivingEntity placer, ItemStack itemStack) {
        ...
        if (itemStack.hasCustomName() && (blockEntity = world.getBlockEntity(pos)) instanceof DepositerBlockEntity) {
//            ((IgneousPlacerBlockEntity)blockEntity).setCustomName(itemStack.getName());
    ...
    public void onStateReplaced(BlockState state, World world, BlockPos pos, BlockState newState, boolean moved) {
        ...
        if (blockEntity instanceof DepositerBlockEntity) {
            ItemScatterer.spawn(world, pos, (DepositerBlockEntity) blockEntity);
